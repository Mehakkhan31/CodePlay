  ...
  return (
    <div className='p-4 max-w-7xl flex justify-between items-center w-full'>
      <div className=' flex gap-2 items-center'>
        ...
        <h2 className='text-3xl font-game'>CodePlay</h2>
      </div>
      ...
      <NavigationMenu>
        ...
        md:w-[500px] lg:w-[600px]'>
                {courses.map((course, index) => (
                  <div key={index} className='p-2 hover:bg-accent rounded-xl curser-ponter'>
      ...
      <div className='flex gap-2 items-center'>
        <Show when="signed-out">
          <SignInButton mode='modal'>
            <Button variant={'outline'} className='font-game text-xl'>Login</Button>
          </SignInButton>
          <SignUpButton mode='modal'>
            <Button className='font-game text-2xl px-4' variant={'pixel'}>SignUp</Button>
          </SignUpButton>
        </Show>
        <Show when="signed-in">
          <UserButton />
